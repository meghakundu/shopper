...
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        ...
        <p class="m-0 pt-5 text-bold w-100">Order Id - <span class="gray-color">{{$items->id}}</span></p>
        <p class="m-0 pt-5 text-bold w-100">Order Date - <span class="gray-color">{{$items->created_at}}</span></p>
    </div>
